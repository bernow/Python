...
class Article(models.Model):
    ...
    image = models.ImageField(blank=True)  # 빈 값도 받아준다(상호호환을 하기 위해).
    ...
    user_like = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='like_articles', blank=True)
